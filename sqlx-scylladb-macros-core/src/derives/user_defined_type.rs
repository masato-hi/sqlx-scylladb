...
pub fn expand_user_defined_type(item: DeriveInput) -> syn::Result<TokenStream> {
    ...
    let tokens = quote! {
        ...
        #[automatically_derived]
        impl ::sqlx_scylladb::ext::sqlx_core::types::Type<::sqlx_scylladb::ScyllaDB> for #struct_ident {
        ...
        #[automatically_derived]
        impl<'r> ::sqlx_scylladb::ext::sqlx_core::encode::Encode<'_, ::sqlx_scylladb::ScyllaDB> for #struct_ident
        where Self: ::sqlx_scylladb::UserDefinedType<'r> {
            fn encode_by_ref(&self, buf: &mut ::sqlx_scylladb::ScyllaDBArgumentBuffer) -> Result<::sqlx_scylladb::ext::sqlx_core::encode::IsNull, ::sqlx_scylladb::ext::sqlx_core::error::BoxDynError> {
                use ::sqlx_scylladb::UserDefinedType as _;

                let argument = ::sqlx_scylladb::ScyllaDBArgument::UserDefinedType(self.box_cloned());
                buf.push(argument);

                Ok(::sqlx_scylladb::ext::sqlx_core::encode::IsNull::No)
            }
        }

        #[automatically_derived]
        impl ::sqlx_scylladb::ext::sqlx_core::decode::Decode<'_, ::sqlx_scylladb::ScyllaDB> for #struct_ident {
            fn decode(value: ::sqlx_scylladb::ScyllaDBValueRef<'_>) -> Result<Self, ::sqlx_scylladb::ext::sqlx_core::error::BoxDynError> {
